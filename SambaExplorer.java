...
public class SambaExplorer extends android.app.ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (mHost == null) {
            ...
            //startActivity(new Intent(this,net.peaknw.sambaexplorer.PickHost.class));
            ...
            try {
                ...
                startActivity(new Intent(this, net.peaknw.sambaexplorer.SambaLogin.class).putExtra("path", mHost));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case 2:
                Intent intent = new Intent(this, net.peaknw.sambaexplorer.DownloadQueue.class);
                startActivity(intent);
                break;
        }
        return false;
        ...
        try{
            ...
            for(int i = 0; l != null && i < l.length; i++ ) {
                try {
                    ...
                    startActivity(new Intent(this, net.peaknw.sambaexplorer.SambaLogin.class).putExtra("path", l[i].getCanonicalPath()));
            ...
            startActivity(new Intent(this, net.peaknw.sambaexplorer.SambaLogin.class).putExtra("path", f.getCanonicalPath()));
        }catch(Exception e){
            AddListItem(e.toString());
        }
    }
